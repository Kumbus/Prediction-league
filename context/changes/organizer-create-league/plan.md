...
- [x] 1.3 POST /api/leagues returns 201 with an 8-character invite code — fd7ad89
- [x] 1.4 SQL: 6 ScoringRules rows + 1 LeagueMemberships row with Role = 0 — fd7ad89
- [x] 1.5 Two creates produce different invite codes — fd7ad89
- [x] 1.6 POST against a draft tournament returns 400 — fd7ad89
- [x] 1.7 GET /api/leagues is caller-scoped — fd7ad89
- [x] 1.8 GET /api/leagues/{id} as a non-member returns 404 — fd7ad89
- [x] 1.9 Anonymous calls return 401 — fd7ad89

### Phase 2: Client — league screens

#### Automated

- [x] 2.1 Client builds: `npm run build` — fd7ad89
- [x] 2.2 Lint passes: `npm run lint` — fd7ad89

#### Manual

- [x] 2.3 Create a league end-to-end from /app — fd7ad89
- [x] 2.4 Scoring fields prefilled and persisted as edited — fd7ad89
- [x] 2.5 Tournament dropdown lists only published tournaments — fd7ad89
- [x] 2.6 Invite code visible with working copy button — fd7ad89
- [x] 2.7 List survives reload and is not visible to another user — fd7ad89
- [x] 2.8 Empty name surfaces the server message inline — fd7ad89
