...
namespace PredictionLeague.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260815192037_AddPredictions")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PredictionLeague.Domain.Entities.Prediction", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<Guid?>("PredictedFirstScorerPlayerId")
                        .HasColumnType("uniqueidentifier");

                    b.Property<Guid?>("PredictedFirstScorerTeamId")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<int?>("PredictedTotalCards")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("PredictedFirstScorerPlayerId");

                    b.HasIndex("PredictedFirstScorerTeamId");
            ...
            modelBuilder.Entity("PredictionLeague.Domain.Entities.Prediction", b =>
                {
                    ...
                    b.HasOne("PredictionLeague.Domain.Entities.Player", null)
                        .WithMany()
                        .HasForeignKey("PredictedFirstScorerPlayerId")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.HasOne("PredictionLeague.Domain.Entities.Team", null)
                        .WithMany()
                        .HasForeignKey("PredictedFirstScorerTeamId")
                        .OnDelete(DeleteBehavior.Restrict);
                });
